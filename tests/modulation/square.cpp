...
TEST(Modulation, Square) {
  ...
  autd.send(autd3::modulation::Square(200 * autd3::driver::Hz)
                .with_low(32)
                .with_high(85)
                .with_duty(0.1f));
  ...
  autd.send(autd3::modulation::Square(150 * autd3::driver::Hz)
...
TEST(Modulation, SquareWithMode) {
  ...
  autd.send(
      autd3::modulation::Square::from_freq_nearest(150.f * autd3::driver::Hz));
  ...
  ASSERT_THROW(autd.send(autd3::modulation::Square(100.1f * autd3::driver::Hz)),
               autd3::AUTDException);
  autd.send(
      autd3::modulation::Square::from_freq_nearest(100.1f * autd3::driver::Hz));
}
