...
TEST(Modulation, SineWithMode) {
  ...
  autd.send(
      autd3::modulation::Sine::from_freq_nearest(150.f * autd3::driver::Hz));
  ...
  ASSERT_THROW(autd.send(autd3::modulation::Sine(100.1f * autd3::driver::Hz)),
               autd3::AUTDException);
  autd.send(
      autd3::modulation::Sine::from_freq_nearest(100.1f * autd3::driver::Hz));
}
