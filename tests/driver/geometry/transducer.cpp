...
TEST(DriverGeomtry, TransducerPosition) {
  ...
  ASSERT_EQ(autd[0][0].position(), autd3::driver::Point3::origin());
  ASSERT_EQ(autd[0][autd3::driver::AUTD3::NUM_TRANS_IN_UNIT - 1].position(), autd3::driver::Point3(172.72f, 132.08f, 0));

  ASSERT_EQ(autd[1][0].position(), autd3::driver::Point3::origin());
  ASSERT_EQ(autd[1][autd3::driver::AUTD3::NUM_TRANS_IN_UNIT - 1].position(), autd3::driver::Point3(172.72f, 132.08f, 0));
}
